# CSMA/CD Transmission Procedure
...
# Minimum Packet Size for Collision Detection

## Why Do We Need a Minimum Packet Size?
- If a frame is **too short**, the sender might **finish transmission before a collision is detected**.
